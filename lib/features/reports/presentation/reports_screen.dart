  ...
  void _export(String format) async {
    ...
    try {
      final url = await ref
          ...
          .exportReport(_reportType, format, _monthString);
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Report exported: $url')));
      }
    } catch (e) {
      if (mounted) {
    ...
    if (_reportType == 'attendance') {
      ...
      return Column(
        ...
        children: [
          ...
          Text(
            'Processed: ${summary['processedCount'] ?? 0} / ${summary['totalEmployees'] ?? 0}',
          ),
        ],
      );
                      ...
                      children: [
                        AppCard(
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${_reportType.toUpperCase()} SUMMARY',
